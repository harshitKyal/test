...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3Byb2Nlc3MvYWRkLXN0ZXAvYWRkLXN0ZXAuY29tcG9uZW50LnNjc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3Byb2Nlc3MvZHluYW1pYy1wcm9jZXNzL2R5bmFtaWMtcHJvY2Vzcy5jb21wb25lbnQuc2NzcyJ9 */"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _theme_model_process_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../@theme/model/process-class */ "./src/app/@theme/model/process-class.ts");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm5/ng-bootstrap.js");
/* harmony import */ var _add_step_add_step_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../add-step/add-step.component */ "./src/app/pages/process/add-step/add-step.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DynamicProcessComponent = /** @class */ (function () {
    function DynamicProcessComponent(_modalService) {
        this._modalService = _modalService;
        this.processModal = new _theme_model_process_class__WEBPACK_IMPORTED_MODULE_1__["Process"]();
        this.scouringRecord = new _theme_model_process_class__WEBPACK_IMPORTED_MODULE_1__["ProcessRecord"]();
        this.stepList = [];
        this.addFunctionFlag = false;
        this.currentSelectedFunction = '';
        this.functionDropdown = [{ 'id': 'chemical', 'name': 'Add Chemical' }, { 'id': 'temp', 'name': 'Add Temperature' }, { 'id': 'pressure', 'name': 'Add Pressure' }];
    }
    ...
    DynamicProcessComponent.prototype.onAddFunction = function () {
        this.addFunctionFlag = true;
    };
    DynamicProcessComponent.prototype.onAddStep = function () {
        var _this = this;
        var modalRef = this._modalService.open(_add_step_add_step_component__WEBPACK_IMPORTED_MODULE_3__["AddStepComponent"]);
        ...
        modalRef.result
            ...
            if (result) {
                if (!_this.stepList.length || result.position == _this.stepList.length + 1) {
                    _this.stepList.push({ 'name': result.name, 'position': result.position, 'functionList': [] });
                }
                else {
                    _this.stepList.splice(result.position - 1, 0, { 'name': result.name, 'position': result.position, 'functionList': [] });
                }
            }
        });
    };
    ...
    DynamicProcessComponent.prototype.onAddFormData = function (form) {
        var _this = this;
        var funcName = '';
        var func;
        var i = this.functionDropdown.findIndex(function (v) { return v.id == _this.currentSelectedFunction; });
        if (i > -1) {
