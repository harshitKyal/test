(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~app-pages-pages-module~batch-batch-module"],{
...
module.exports = ".errors {\n  color: red;\n  font-size: 13px; }\n\noptgroup[label=\"GR BATCH_NO WEIGHT METRE NO_OF_CONES/TAKA\"] {\n  color: red; }\n\noptgroup {\n  margin: 1em;\n  border: 1px solid green; }\n\noptgroup option {\n  margin: 1em;\n  border: 1px solid orange; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _theme_model_batch_class__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../@theme/model/batch-class */ "./src/app/@theme/model/batch-class.ts");
...
/* harmony import */ var _theme_services_batch_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../@theme/services/batch.service */ "./src/app/@theme/services/batch.service.ts");
...
var AddEditBatchComponent = /** @class */ (function () {
    function AddEditBatchComponent(toasterService, route, qualityService, router, batchService, authService) {
        var _this = this;
        ...
        this.items = [];
        this.batchModal = new _theme_model_batch_class__WEBPACK_IMPORTED_MODULE_3__["BatchMast"]();
        this.batchDataObj = new _theme_model_batch_class__WEBPACK_IMPORTED_MODULE_3__["BatchData"]();
    ...
    AddEditBatchComponent.prototype.onAddRecord = function (form) {
                    ...
                    if (_this.items.length) {
                        _this.items.forEach(function (ele, index) {
                            if (ele.entry_id === undefined) {
                                var obj = new _theme_model_batch_class__WEBPACK_IMPORTED_MODULE_3__["BatchWeightMtrDetail"]();
                                obj = ele;
        ...
        // }
        this.batchDetailObj = [];
        this.rowData = this.batchDataArray.slice();
        this.batchDataObj = new _theme_model_batch_class__WEBPACK_IMPORTED_MODULE_3__["BatchData"]();
        form.resetForm();
    };
    ...
    AddEditBatchComponent = __decorate([
        ...
        __metadata("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_1__["ToastrService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _theme_services_quality_service__WEBPACK_IMPORTED_MODULE_4__["QualityService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _theme_services_batch_service__WEBPACK_IMPORTED_MODULE_7__["BatchService"], _theme_services_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]])
...
//# sourceMappingURL=default~app-pages-pages-module~batch-batch-module.js.map